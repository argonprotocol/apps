...
// Runtime compatibility source: mainnet spec 157 at 0x8c03ceccae43d0350064a76d2ba704d27cd047e5f51b18d137430e2ec08f8b2a, @argonprotocol/mainchain@1.4.11
/* eslint-disable */
...
export namespace PreviousRuntimeSpec {
  ...
  export interface PalletOperationalAccountsCall extends Enum {
    ...
    readonly type: 'Register' | 'SetRewardConfig' | 'ForceSetProgress' | 'Activate' | 'ClaimRewards';
  }
  ...
  export interface PalletVaultsRecentCapacityDrop extends Struct {
