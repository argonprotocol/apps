<!-- prettier-ignore -->
<template>
  <div v-if="config.isServerAdded">
    <p>Your mining machine is already connected. You cannot change the IP address at this time.</p>
  </div>
  <div v-else>
    <RadioGroupRoot
      v-model="setupType"
...
const shouldHideSaveButton = Vue.ref(config.isServerAdded);
