<template>
  <div ref="editBoxParent" class="relative flex grow flex-col px-5 text-lg">
    ...
    <section class="my-2 flex grow flex-row" :class="includeProjections ? 'h-1/2' : ''">
      ...
      <div MainWrapperParent ref="poolRevenueShareParent" :class="includeProjections ? 'w-1/2' : 'w-1/3'">
        <Tooltip
          asChild
      ...
      <!-- Bitcoin Locking Fee: in row 1 when !includeProjections, row 2 when includeProjections -->
      <template v-if="!includeProjections">
        <div class="mx-2 w-[1px] bg-slate-300" />
