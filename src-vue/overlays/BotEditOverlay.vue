      ...
      <DialogContent @escapeKeyDown="cancelOverlay" :aria-describedby="undefined">
        ...
        >
          ...
          <div class="flex flex-col h-full w-full grow">
            ...
            >
              <DialogTitle as="div" class="relative z-10">Configure Bot Settings</DialogTitle>
            ...
            <div v-if="isLoaded" class="flex flex-col grow relative w-full">
              <DialogDescription class="text-gray-600 font-light py-6 pl-10 pr-[6%]">
                The following settings determine how your bot will make bidding decisions on your behalf.
              </DialogDescription>

              <BotSettings ref="botSettings" @toggleEditBoxOverlay="(x: boolean) => hasEditBoxOverlay = x" :includeProjections="false" class="h-full grow" />
            </div>
