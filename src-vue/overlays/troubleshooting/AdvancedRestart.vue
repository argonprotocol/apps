...
function updateDisabledOptions() {
  const isServerMissing = !config.isServerAdded;
  const isServerInstalling = config.isServerInstalling || installer.isRunning;

  options.value[AdvancedRestartOption.RecreateLocalDatabase].isDisabled = installer.isRunning;
  options.value[AdvancedRestartOption.RestartDockers].isDisabled = isServerInstalling;
  options.value[AdvancedRestartOption.ResyncBiddingDataOnCloudMachine].isDisabled = isServerInstalling;
  options.value[AdvancedRestartOption.ResyncBitcoinBlocksOnCloudMachine].isDisabled = isServerInstalling;
  options.value[AdvancedRestartOption.ResyncArgonBlocksOnCloudMachine].isDisabled = isServerInstalling;
  options.value[AdvancedRestartOption.CompletelyWipeAndReinstallCloudMachine].isDisabled = isServerMissing;
}
