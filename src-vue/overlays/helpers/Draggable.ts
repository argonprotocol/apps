...
export default class Draggable {
  ...
  private constrainToViewport: boolean;

  constructor(options: { constrainToViewport?: boolean } = {}) {
  ...
  public onMouseDown(event: MouseEvent) {
    ...
    const isNotDraggable = targetElement?.hasAttribute('notdraggable') || targetElement?.closest('[notdraggable]');
  ...
  private onDragMove = (e: MouseEvent) => {
    ...
    if (this.constrainToViewport && modalElem) {
