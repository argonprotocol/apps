  ...
  <div class="relative flex h-full flex-col items-center justify-center grow px-6 py-4">
    ...
    <div class="flex w-fit max-w-full flex-col pb-10">
      ...
      <div class="flex flex-row justify-center mt-12">
        <button class="w-7/12 border bg-argon-button border-argon-button-hover hover:bg-argon-button-hover text-white font-bold inner-button-shadow px-12 py-2 rounded-md cursor-pointer focus:outline-none">
          Add Capital to Your Account
        </button>
      </div>
    </div>
  </div>
