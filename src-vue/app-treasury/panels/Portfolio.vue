...
function toTreasuryPortfolioTab(tab: EmitterPortfolioTab): PortfolioTab {
  switch (tab) {
    case EmitterPortfolioTab.AssetBreakdown:
      return PortfolioTab.AssetBreakdown;
    case EmitterPortfolioTab.ProfitAnalysis:
      return PortfolioTab.ProfitAnalysis;
    case EmitterPortfolioTab.TransactionHistory:
      return PortfolioTab.TransactionHistory;
    case EmitterPortfolioTab.Overview:
    case EmitterPortfolioTab.GrowthProjections:
      return PortfolioTab.Overview;
  }
}

basicEmitter.on('openPortfolioPanel', async (tab: EmitterPortfolioTab) => {
  if (isOpen.value) return;
  isLoaded.value = false;

  selectedTab.value = toTreasuryPortfolioTab(tab);
  isLoaded.value = true;
  isOpen.value = true;
});
</script>
