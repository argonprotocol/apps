...
import AlertBarRow from '../alerts-shared/AlertBarRow.vue';
import BitcoinAlert from '../alerts-shared/BitcoinAlert.vue';
import VaultAlert from '../alerts-shared/VaultAlert.vue';
import {
  buildAlertSummary,
