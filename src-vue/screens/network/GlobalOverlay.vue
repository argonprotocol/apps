<template>
  <section StatsBox box class="flex h-1/2 grow flex-col justify-center px-2 !pb-0">
    <header
    ...
    >
      ...
      <div class="relative top-5 ml-2 h-9 w-3 bg-slate-600/16">
        ...
        <LineArrow
          class="absolute top-full left-1/2 z-10 -translate-x-1/2 -translate-y-4/12 rotate-90 text-slate-600/16"
        />
      </div>
    </header>
    <div class="mt-2 -mb-2 flex w-full grow flex-row">
      <div class="flex w-1/3 flex-col">
        ...
        <div class="ml-10 flex h-[20%] flex-row items-center space-x-4 pt-[5%]">
          <div StatWrapper>
      ...
      <div class="flex w-1/3 flex-col items-center">
        ...
        <div StatWrapper class="mt-2 flex h-[20%] w-full flex-col pt-[5%] text-center">
      ...
      <div class="flex w-1/3 flex-col text-right">
        ...
        <div class="mr-10 flex h-[20%] flex-row items-center justify-end space-x-4 pt-[5%]">
          <div class="relative flex h-full grow flex-col">
          ...
          <div StatWrapper>
            <div Stat>
              {{ currency.symbol }}{{ microgonToMoneyNm(liquidityReceived).formatIfElse('< 1_000', '0,0.[00]', '0,0') }}
            </div>
