    ...
    <div class="pointer-events-auto relative" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
      <DropdownMenuRoot :openDelay="0" :closeDelay="0" v-model:open="isOpen">
        <DropdownMenuTrigger
          ...
          class="h-[34px] flex flex-row items-center justify-center group-hover:border-slate-400/50 group-hover:bg-slate-400/10 hover:border-slate-400/50 hover:bg-slate-400/10 focus:outline-none border rounded-md"
