    ...
    <div class="absolute inset-0 z-100 overflow-y-auto pt-[1px] flex items-center justify-center pointer-events-none">
      ...
      >
        ...
        >
          ...
          <p>
            You are about to remove your mining machine from this app. Completing this action will not stop any active
...
import { type IConfigServerInstallDetails, ServerType } from '../interfaces/IConfig';
