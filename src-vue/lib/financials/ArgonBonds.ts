        ...
        positions.push(
          createFinancialPosition(
            'bond',
            {
              ...
              lifecycle,
              excludeFromAccountReturn: ownedVaultId !== undefined && bondLot.vaultId === ownedVaultId,
              startedAt,
              bondLot,
              nativeAsset: 'ARGN',
              nativePrincipal,
      ...
      positions.push(
        createFinancialPosition(
          'bond',
          {
            ...
            label,
            lifecycle: 'completed',
            excludeFromAccountReturn: ownedVaultId !== undefined && record.vaultId === ownedVaultId,
