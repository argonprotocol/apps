...
export class BitcoinFissionsTable extends BaseTable {
  ...
  public async saveRecoveredRecord(recovered: IBitcoinFissionRecord): Promise<IBitcoinFissionRecord> {
    ...
    const record: IBitcoinFissionRecord = {
      ...
      createdAtArgonBlock: fission.createdAtArgonBlock ?? durable.createdAtArgonBlock,
      lastUpdatedArgonBlock: fission.lastUpdatedArgonBlock ?? durable.lastUpdatedArgonBlock,
