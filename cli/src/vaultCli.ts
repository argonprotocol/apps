...
export default function vaultCli() {
  ...
  program
    ...
    .requiredOption('-a, --argons <amount>', 'The number of argons to set as securitization', parseFloat)
  ...
  program
    ...
    .action(async ({ tip, argons, vaultId, bitcoinPubkey }) => {
      ...
      const vaultModifyTx = client.tx.vaults.modifyFunding(vaultId, microgons, rawVault.securitizationRatio.toBigInt());
